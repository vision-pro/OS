...
const fieldsByEntity: Record<Entity, Array<{ key: string; label: string; type?: "text" | "textarea" | "number" | "checkbox" | "select"; required?: boolean; options?: Array<[string, string]> }>> = {
  ...
  services: [{ key: "slug", label: "الرابط المختصر", required: true }, { key: "titleAr", label: "العنوان بالعربية", required: true }, { key: "titleEn", label: "العنوان بالإنجليزية", required: true }, { key: "summaryAr", label: "الملخص العربي", type: "textarea" }, { key: "summaryEn", label: "English summary", type: "textarea" }, { key: "descriptionAr", label: "الوصف العربي", type: "textarea" }, { key: "descriptionEn", label: "English description", type: "textarea" }, { key: "icon", label: "اسم الأيقونة (Lucide)" }, { key: "sortOrder", label: "ترتيب العرض", type: "number" }, { key: "isActive", label: "نشط", type: "checkbox" }],
  achievements: [{ key: "titleAr", label: "العنوان بالعربية", required: true }, { key: "titleEn", label: "العنوان بالإنجليزية", required: true }, { key: "descriptionAr", label: "الوصف العربي", type: "textarea" }, { key: "descriptionEn", label: "English description", type: "textarea" }, { key: "achievementDate", label: "تاريخ الإنجاز" }, { key: "sortOrder", label: "ترتيب العرض", type: "number" }, { key: "isPublished", label: "منشور", type: "checkbox" }],
...
const editorSectionOrder = [
  ...
  { id: "visibility", title: "الظهور والترتيب", keys: ["status", "isFeatured", "isActive", "isPublished", "isVerified", "showInNavigation", "navigationOrder", "sortOrder"] },
